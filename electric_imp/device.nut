...
class printer {
    ...
    */
    ...
    function printImg(width, height, offset, data) {
        ...
        local nothing = data.readblob(offset);
...
agent.on("actuallyPrint", function(arrData){
    myPrinter.printImg(arrData[1], arrData[2], arrData[3], arrData[0]);
});